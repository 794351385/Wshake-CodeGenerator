...
public class Mapper implements ITemplate {
    ...
    private Boolean isOuterMapper = true;
    private Boolean isOuterXml = true;
    public Boolean isOuterMapper() {
        return isOuterMapper;
    }
    ...
    private String fileSuffixNameXml="Mapper";

    private String filePrefixNameXml="";
    ...
    public Map<String, Object> renderData() {
        ...
        data.put("fileSuffixNameMapper", this.fileSuffixNameMapper);
        data.put("filePrefixNameMapper", this.filePrefixNameMapper);
        data.put("fileSuffixNameXml", this.fileSuffixNameXml);
        data.put("filePrefixNameXml", this.filePrefixNameXml);
        if (enableCache) {
    ...
    public static class Builder extends BaseBuilder {
        ...
        public Mapper.Builder noOuterMapper() {
            mapper.isOuterMapper = false;
            return this;
        }
        ...
        public Mapper.Builder filePrefixNameMapper(String filePrefixName){
            this.mapper.filePrefixNameMapper = filePrefixName;
            return this;
        }
        public Mapper.Builder fileSuffixNameMapper(String fileSuffixName){
            this.mapper.fileSuffixNameMapper=fileSuffixName;
            return this;
        }

        public Mapper.Builder filePrefixNameXml(String filePrefixName){
            this.mapper.filePrefixNameXml = filePrefixName;
            return this;
        }
        public Mapper.Builder fileSuffixNameXml(String fileSuffixName){
            this.mapper.fileSuffixNameXml=fileSuffixName;
            return this;
        }
